    ...
    <div class="container">
        <div class="row">
            <div class="mb-5 col-lg-4">
                ...
                <article class="card">
                    <div class="post-slider slider-sm">
                        <img src="{{ asset('usr_assets/images/post/post-1.jpg') }}" class="card-img-top" alt="post-thumb">
                    </div>

                    <div class="card-body">
                        <h3 class="mb-3 h4"><a class="post-title" href="post-details.html">Use apples to give
            ...
            <div class="mb-5 col-lg-4">
                ...
                <article class="mb-4 card">
                    <div class="card-body d-flex">
                        <img class="card-img-sm" src="{{ asset('usr_assets/images/post/post-2.jpg') }}">
                        <div class="ml-3">
                ...
                <article class="mb-4 card">
                    <div class="card-body d-flex">
                        <img class="card-img-sm" src="{{ asset('usr_assets/images/post/post-4.jpg') }}">
                        <div class="ml-3">
            ...
            <div class="mb-5 col-lg-4">
                ...
                <article class="card">
                    ...
                    <div class="card-body">
                        <h3 class="mb-3 h4"><a class="post-title" href="post-details.html">How To Make Cupcakes
